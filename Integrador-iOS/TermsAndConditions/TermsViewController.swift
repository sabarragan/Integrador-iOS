...
class TermsViewController: UIViewController {
    ...
    private lazy var dismissButton: UIButton = {
        ...
        aButton.setImage(UIImage(systemName: ""), for: .normal)
        return aButton
    }()
...
"""
        ...
        aTextView.textAlignment = .natural
    ...
    func setupConstraints() {
        NSLayoutConstraint.activate([
            titleLabel.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: viewMargin),
